// PatchCreatorDll.cpp : Îïðåäåëÿåò ôóíêöèè äëÿ ñòàòè÷åñêîé áèáëèîòåêè.
//
...
bool MainFunction(Maap*, int,std::string);

bool PatchCreate(Maap* pMaap, int count, const char* a)
{
